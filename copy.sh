...
waybar_style="$HOME/.config/waybar/style/[0 VERTICAL] [Catpuccin] Mocha.css"
waybar_config="$HOME/.config/waybar/configs/[TOP] Simple"
waybar_config_laptop="$HOME/.config/waybar/configs/[TOP] Simple"
